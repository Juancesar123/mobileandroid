...
//import com.garuda.hcmobile.model.ImageGalleryCategoryModel;
//import com.garuda.hcmobile.model.ImageGallerySubcategoryModel;
...
//		return imageGallerySubcategoryModels;
//	}
	public static List<ATimeData> getATimeData(){
		List<ATimeData> list = new ArrayList<ATimeData>();
		list.add(new ATimeData(1, "DD.MM.YYYY", "Day", "DWS","HH:MM","HH:MM",null,null,0,0,0,0,"-"));
//		list.add(new ATimeData(185855195, "02.05.2016", "Monday", "N00","07:30","16:30",null,null,0,0,0,0,"Hari Buruh Internasional"));
//		list.add(new ATimeData(185855195, "02.05.2016", "Monday", "N00","07:30","16:30",null,null,0,0,0,0,"Hari Buruh Internasional"));
//		list.add(new ATimeData(185855195, "02.05.2016", "Monday", "N00","07:30","16:30",null,null,0,0,0,0,"Hari Buruh Internasional"));
//		list.add(new ATimeData(185855195, "02.05.2016", "Monday", "N00","07:30","16:30",null,null,0,0,0,0,"Hari Buruh Internasional"));
		return list;
...
//		ArrayList<DummyModel> list = new ArrayList<>();
//		list.add(new DummyModel(0, "", "HC-News", R.string.material_icon_note));
//		return list;
//	}
//	public static ArrayList<MenuModel> getMenuDummyList() {
//		ArrayList<MenuModel> list = new ArrayList<>();
//		list.add(new MenuModel(0, "HC-News", R.string.material_icon_newspaper,99));
//		list.add(new MenuModel(0, "HC-News", R.string.material_icon_clock,99));
//		return list;
//	}
//
